...
Go straight to the Shiny app: [here](https://fhoces.shinyapps.io/shiny_app_test/)
...
1 - [An interactive plot](https://fhoces.shinyapps.io/shiny_app_test/), which summarizes the interactions between all key parameters for a given set of assumptions. Materials can be found in: [`code/shiny_app`](https://github.com/BITSS-OPA/opa-template/tree/main/code/shiny_app).
